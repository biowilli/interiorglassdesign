  ...
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex mt-20">
            <div class="flex flex-col items-center mx-auto my-4">
              ...
              <div class="mx-auto my-4"><EasyTrans>processStep1</EasyTrans></div>
            </div>
            <div class="flex flex-col items-center mx-auto my-4">
              <div class="text-6xl flex items-center justify-center h-24 w-24 rounded-full bg-fairblue text-white">
                2
              </div>
              <div class="mx-auto my-4"><EasyTrans>processStep2</EasyTrans></div>
            </div>
            <div class="flex flex-col items-center mx-auto my-4">
              <div class="text-6xl flex items-center justify-center h-24 w-24 rounded-full bg-fairblue text-white">
                3
              </div>
              <div class="mx-auto my-4"><EasyTrans>processStep3</EasyTrans></div>
            </div>
            <div class="flex flex-col items-center mx-auto my-4">
              <div class="text-6xl flex items-center justify-center h-24 w-24 rounded-full bg-fairblue text-white">
                4
              </div>
              <div class="mx-auto my-4"><EasyTrans>processStep4</EasyTrans></div>
            </div>
            <div class="flex flex-col items-center mx-auto my-4">
              <div class="text-6xl flex items-center justify-center h-24 w-24 rounded-full bg-fairblue text-white">
                5
              </div>
              <div class="mx-auto my-4"><EasyTrans>processStep5</EasyTrans></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="reachout" className="m-6 py-12  bg-fairpage">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-fairblue font-semibold tracking-wide uppercase">
            <div class="mx-auto my-4"><EasyTrans>intrest</EasyTrans></div>
            </h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
